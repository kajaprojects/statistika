...
##2, 6a. 
Zanima nas, kakšna je verjetnost, da so potniki preživeli glede na to, koliko so bili
stari (age), kakšnega spola so bili (sex), v katerem razredu so potovali (pclass) in ali so
